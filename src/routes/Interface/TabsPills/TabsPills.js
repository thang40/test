                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills>
                                ...
                                <NavItem>
                                    <NavLink href="google.com" disabled>
                                        Logout
                                    </NavLink>
                                </NavItem>
                            </Nav>
                ...
                <Col lg={ 6 }>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="google.com" active className="flex-sm-fill d-flex justify-content-between">
                                ...
                                <NavItem>
                                    <NavLink href="google.com" className="flex-sm-fill d-flex justify-content-between">
                                        <Badge color="secondary" className="align-self-center">
                                            2.300
                                        </Badge> 
                                        <span className="align-self-center">
                                ...
                                <NavItem>
                                    <NavLink href="google.com" className="flex-sm-fill d-flex justify-content-between" disabled>
                                        <Badge color="secondary" className="align-self-center">
                                            7.082
                                        </Badge> 
                                        <span className="align-self-center">
                ...
                <Col lg={ 6 }>
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="google.com" active className="d-flex">
                                        Profile
                                        <i className="fa fa-fw fa-user ml-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="google.com" className="d-flex">
                                        Settings
                                        <i className="fa fa-fw fa-gear ml-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="google.com" className="d-flex" disabled>
                                        Logout
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="google.com" className="d-flex" active>
                ...
                <Col lg={ 6 }>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav tabs>
                                <NavItem>
                                    <NavLink href="google.com" active className="text-center">
                                        <i className="fa fa-fw fa-user"></i>
                                        <div>Profile</div>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="google.com" className="text-center">
                                        <i className="fa fa-fw fa-gear"></i>
                                        <div>Settings</div>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="google.com" className="text-center" disabled>
                                        <i className="fa fa-fw fa-sign-out"></i>
                                        <div>Logout</div>
                                    </NavLink>
                                </NavItem>
