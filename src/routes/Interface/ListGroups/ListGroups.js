...
import { randomAvatar } from '../../../utils/utilities';
            ...
            <Row>
                ...
                <Col lg={ 6 }>
                    ...
                    <div className="mb-5">
                        ...
                        <ListGroup>
                            <ListGroupItem active tag="a" href="google.com" action>Cras justo odio</ListGroupItem>
                            <ListGroupItem tag="a" href="google.com" action>Dapibus ac facilisis in</ListGroupItem>
                            <ListGroupItem tag="a" href="google.com" action>Morbi leo risus</ListGroupItem>
                            <ListGroupItem tag="a" href="google.com" action>Porta ac consectetur ac</ListGroupItem>
                            <ListGroupItem disabled tag="a" href="google.com" action>Vestibulum at eros</ListGroupItem>
                        </ListGroup>
                    </div>
                    { /* END Example */}
                    { /* START Example */}
                ...
                <Col lg={ 6 }>
                    ...
                    <div className="mb-5">
                        ...
                        <p>
                            The most basic list group is an unordered list with 
                            list items and the proper classes. Example: <code>
                                &lt;ListGroupItem active tag="a" href="google.com" action&gt; ... &lt;/ListGroupItem&gt;
                            </code>.
                        </p>
                        <ListGroup>
                            <ListGroupItem active tag="a" href="google.com" action>Cras justo odio</ListGroupItem>
                    ...
                    <div className="mb-5">
                        ...
                        <ListGroup>
                            <ListGroupItem active tag="button" href="google.com" action>Cras justo odio</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Dapibus ac facilisis in</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Morbi leo risus</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Porta ac consectetur ac</ListGroupItem>
                            <ListGroupItem disabled tag="button" href="google.com" action>Vestibulum at eros</ListGroupItem>
                        </ListGroup>
                    </div>
                    { /* END Example */}
                    { /* START Example */}
                    <div className="mb-5">
                        ...
                        <ListGroup flush>
                            <ListGroupItem tag="button" href="google.com" action>Cras justo odio</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Dapibus ac facilisis in</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Morbi leo risus</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Porta ac consectetur ac</ListGroupItem>
                            <ListGroupItem tag="button" href="google.com" action>Vestibulum at eros</ListGroupItem>
                        </ListGroup>
                    </div>
                    { /* END Example */}
                    { /* START Example */}
            ...
            <Row>
                ...
                <Col lg={ 6 }>
                    ...
                    <div className="mb-5">
                        ...
                        <ListGroup>
                            <ListGroupItem tag="button" action href="google.com">
                                <Media>
