                ...
                <Col lg={ 6 }>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <div>
                                <p>
                                    This is an example <a href="google.com" className="text-primary">Primary Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-secondary">Secondary Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-success">Success Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-danger">Danger Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-warning">Warning Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-info">Info Link</a>
                                </p>
                                <p>
                                    This is an example <a href="google.com" className="text-dark">Dark Link</a>
                                </p>
                                <p>
                                    <a href="google.com" className="text-light bg-dark">Light Link</a>
                                </p>
                            </div>
                        </CardBody>
                    </Card>
