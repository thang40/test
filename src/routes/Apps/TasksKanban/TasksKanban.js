                    ...
                    <CardColumns>
                                ...
                                <div className="mb-4">
                                    ...
                                    <span className="small d-flex">
                                        ...
                                        <span className="ml-auto">
                                            <a href="google.com" className="mr-2" id="TooltipSettings">
                                                <i className="fa fa-gear"></i>
                                            </a>
                                            <a href="google.com" className="mr-2" id="TooltipCollapse">
                                                <i className="fa fa-angle-down"></i>
                                            </a>
                                            <a href="google.com" id="TooltipAddNew">
                        ...
                        <Card type="border-dash">
                            <CardBody className="d-flex align-items-center justify-content-center">
                                <a href="google.com" className="py-5">
                                    <i className="fa fa-plus text-success mr-2"></i>
                                    Add New Column
                                </a>
                            </CardBody>
