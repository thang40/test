...
import { randomArray, randomAvatar } from '../../../utils/utilities';
        ...
        <Card className="mb-3">
            ...
            <CardBody>
                <Media className="mb-3">
                    ...
                    <Media body>
                        <span>
                            <a className="h6 text-decoration-none" href="google.com">
                    ...
                    <Media right>
                        <a href="google.com" className="ml-auto" id={`galleryCardTooltip-${ props.id }` }>
                ...
                <Media className="mb-3">
                    ...
                    <Media body>
                        <a className="mt-0 d-flex text-decoration-none" href="google.com">
