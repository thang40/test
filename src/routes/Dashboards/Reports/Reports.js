...
import { setupPage } from '../../../commons/components/airDashboard//Layout/setupPage';
        ...
        <Row className="mb-2">
            ...
            <Col xl={ 3 } lg={ 6 } className="mb-4 mb-lg-0">
                <Card>
                    <CardBody className="bb-0">
                        <span className="d-flex">
                            ...
                            <span className="ml-auto justify-content-start">
                                <a href="google.com" className="ml-auto justify-content-start pr-2 text-decoration-none" id="TemperaturesTooltipSettings">
                                    <i className="fa fa-fw fa-sliders"></i>
                                </a> <a href="google.com" id="TemperaturesTooltipAdd" className="text-decoration-none">
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="TemperaturesProcessorToggler" className="by-0 d-flex text-decoration-none">
                            Processor
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="TemperaturesGraphicsToggler" className="by-0 d-flex text-decoration-none">
                            Graphics
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="TemperaturesStorageToggler" className="by-0 d-flex text-decoration-none">
                            Storage
                ...
                <Card className="mb-sm-4 mb-xl-0">
                    <CardBody className="bb-0">
                        <span className="d-flex">
                            ...
                            <span className="ml-auto justify-content-start">
                                <a href="google.com" className="ml-auto justify-content-start pr-2 text-decoration-none" id="UsageTooltipSettings">
                                    <i className="fa fa-fw fa-sliders"></i>
                                </a> <a href="google.com" id="UsageTooltipAdd" className="text-decoration-none">
                                    <i className="fa fa-fw fa-plus"></i>
                                </a>
                            </span>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="ProcessorToggler" className="by-0 d-flex text-decoration-none">
                            Processor
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="UsageLoadToggler" className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="GraphicsToggler" className="by-0 d-flex text-decoration-none">
                            Graphics
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="google.com" id="UsageLoadToggler2" className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                        ...
                        <Card className="mb-4">
                            <CardBody className="bb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="ml-auto justify-content-start">
                                        <a href="google.com" className="ml-auto justify-content-start pr-2 text-decoration-none" id="AllocationTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
                                        </a> <a href="google.com" id="AllocationTooltipAdd" className="text-decoration-none">
                                            <i className="fa fa-fw fa-plus"></i>
                                        </a>
                                    </span>
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="google.com" id="RamToggler" className="by-0 d-flex text-decoration-none">
                                    RAM
                        ...
                        <Card className="mb-4">
                            <CardBody className="bb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="ml-auto justify-content-start">
                                        <a href="google.com" className="ml-auto justify-content-start pr-2 text-decoration-none" id="CoolingTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
                                        </a> <a href="google.com" id="CoolingTooltipAdd" className="text-decoration-none">
                                            <i className="fa fa-fw fa-plus"></i>
                                        </a>
                                    </span>
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="google.com" id="FansToggler" className="by-0 d-flex text-decoration-none">
                                    Fans
                            ...
                            <UncontrolledCollapse toggler="#FansToggler" isOpen>
                                <CardBody className="pt-0">
                                    ...
                                    <Nav pills className="nav-fill">
                                        <NavItem>
                                            <NavLink href="google.com" active>
                        ...
                        <Card>
                            <CardBody className="bb-0 pb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="ml-auto justify-content-start">
                                        <a href="google.com" className="ml-auto justify-content-start pr-2" id="ActivityTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
                                        </a> <a href="google.com" id="ActivityTooltipAdd">
                                            <i className="fa fa-fw fa-plus"></i>
                                        </a>
                                    </span>
